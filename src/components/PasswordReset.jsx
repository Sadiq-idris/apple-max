...
const PasswordReset = () => {
    ...
    const { resetPassword, setError, error, setMessage } = UserAuth()
        ...
        try{
            await resetPassword(email.current.value)
                .then(()=>{
                    setError('')
                    setIsLoading(true)
                    setMessage("Check your inboxfor further instructions")
                    navigate("/")
                    })
                .catch((error)=>{
        ...
        <section className="w-[90%] mx-auto">
            <div className="w-full md:h-[80vh]  flex items-center justify-centers">
                ...
                ">
                    ...
                    <h2 className="md:text-[40px] text-[30px]  text-center  font-bold ">Rest Password</h2>
                    <form onSubmit={handleSubmit}>
                        ...
                        >Send</button>
                        <Link to="/login" className="text-blue-600 hover:underline  text-center">cancel</Link>
